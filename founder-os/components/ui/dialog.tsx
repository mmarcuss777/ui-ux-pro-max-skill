...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Top-anchored on phones so the iOS keyboard never shoves a
        // centered dialog around mid-typing; classic centering from sm up.
        "fixed left-[50%] top-6 z-50 grid w-[calc(100%-2rem)] max-w-lg translate-x-[-50%] gap-4 rounded-3xl border border-black/[0.06] bg-popover p-6 shadow-elevated duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=open]:slide-in-from-left-1/2 sm:top-[50%] sm:translate-y-[-50%] sm:data-[state=closed]:slide-out-to-top-[48%] sm:data-[state=open]:slide-in-from-top-[48%]",
        className
      )}
      {...props}
    >
